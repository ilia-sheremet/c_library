...
static void mavlink_test_position_to_blade(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_position_to_blade_t packet_in = {
		17235,17339,17443
    };
	mavlink_position_to_blade_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.distance_blade = packet_in.distance_blade;
        	packet1.distance_pillar = packet_in.distance_pillar;
        	packet1.x_position = packet_in.x_position;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_position_to_blade_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_position_to_blade_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_position_to_blade_pack(system_id, component_id, &msg , packet1.distance_blade , packet1.distance_pillar , packet1.x_position );
	mavlink_msg_position_to_blade_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_position_to_blade_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.distance_blade , packet1.distance_pillar , packet1.x_position );
	mavlink_msg_position_to_blade_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_position_to_blade_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_position_to_blade_send(MAVLINK_COMM_1 , packet1.distance_blade , packet1.distance_pillar , packet1.x_position );
	mavlink_msg_position_to_blade_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_position_to_blade(system_id, component_id, last_msg);
